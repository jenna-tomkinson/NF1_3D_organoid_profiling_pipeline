...
def calulate_surface_area(
    ...
    """
    Calculate surface area of each object in a 3D image.

    This function calculates the surface area of each object in a 3D image
    using the marching cubes algorithm.

    Parameters
    ----------
    label_object : numpy.array
        An array of the segmented objects of a given compartment.
    props : numpy.array
        The output of the regionprops function, containing information about the objects.
    spacing : tuple
        The spacing of the image in each dimension (z, y, x).
